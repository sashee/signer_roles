...
module "bucket1" {
  ...
  file         = "cat1.jpg"
  trusted_role = aws_iam_role.lambda_exec.arn
}
...
resource "aws_lambda_function" "signer_lambda" {
  ...
  environment {
    variables = {
      BUCKET_1 = module.bucket1.bucket
      BUCKET_2 = module.bucket2.bucket
      ROLE_1   = module.bucket1.role
      ROLE_2   = module.bucket2.role
    }
  }
}
